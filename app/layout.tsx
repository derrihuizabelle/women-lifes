...
export const metadata: Metadata = {
  title: "Contador de Violência Contra a Mulher no Brasil",
  ...
  openGraph: {
    title: 'Contador de Violência Contra a Mulher no Brasil',
    description: 'Mais de 1.700 casos de violência contra mulheres são registrados por dia no Brasil. Veja a soma de casos desde 2018.',
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Contador de Violência Contra a Mulher no Brasil',
    description: 'Mais de 1.700 casos de violência contra mulheres por dia no Brasil. Incluindo feminicídios, agressões, assédio e violência doméstica.',
  }
}
  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <meta name="author" content="@derrihuizabelle" />
